...
namespace Azi.Amazon.CloudDrive
{
    ...
    public interface IAmazonDrive
    {
        ...
        /// <param name="scope">Access scope. Must be subset of application registered scopesscopes in Amazon Developers Console.</param>
        ...
        Task<bool> AuthenticationByExternalBrowser(TimeSpan timeout, CancellationToken? cancelToken = default(CancellationToken?), string unformatedRedirectUrl = "http://localhost:{0}/signin/", Func<int, int, int> portSelector = null);
