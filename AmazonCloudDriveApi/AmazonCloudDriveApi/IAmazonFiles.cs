...
namespace Azi.Amazon.CloudDrive
{
    ...
    public interface IAmazonFiles
    {
        ...
        Task<FileUploadResult> Overwrite(string id, Func<Stream> streamCreator, CancellationToken? token = null);
        ...
        /// <returns>Node info for overwritten file</returns>
        Task<FileUploadResult> Overwrite(FileUpload fileUpload);
        ...
        Task<FileUploadResult> UploadNew(string parentId, string fileName, Func<Stream> streamCreator, bool allowDuplicate = true);
        ...
        /// <param name="fileUpload">Information about new file</param>
        /// <returns>Node info for new file</returns>
        Task<FileUploadResult> UploadNew(FileUpload fileUpload);
    }
}