...
namespace Azi.Amazon.CloudDrive
{
    ...
    public interface IAmazonNodes
    {
        ...
        Task<AmazonNode> GetNodeByPath(string path, bool isDir);
        ...
        Task<AmazonNode> Move(string nodeid, string newDirId, bool isDir);
        ...
        /// <returns>Operation Task</returns>
        Task Remove(string nodeid, bool isDir);
        ...
        Task<AmazonNode> Rename(string nodeid, string newName, bool isDir);
        ...
        /// <returns>Operation Task</returns>
        Task Trash(string nodeid, bool isDir);
    }
}